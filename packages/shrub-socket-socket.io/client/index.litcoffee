...
Queue up any messages to be emitted before initialization completes, and send
them all immediately upon connection.
...
* (optional Function) `fn` - Callback called with whatever the server returned.
