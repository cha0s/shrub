...
Return the 20 newest notifications from the queue for the request's channel,
skipping as many records as requested.
...
Reverse the notifications because the client will prepend new notifications,
not append.
